...
city_data = {
    ...
    '纬度': [
        ...
        30.8375, 36.7068, 24.4033, 27.2333, 41.7212, 30.2741, 28.8724, 22.7877, 36.6512, 23.1291,
        23.7338, 26.8930, 31.6765, 27.8268, 39.6085, 23.6820, 37.0700, 45.7700, 42.2860, 20.0442
    ],
    '经度': [
        ...
        106.0806, 119.1035, 111.5672, 111.4672, 125.9406, 120.1551, 105.4479, 115.3751, 117.1201, 113.2644,
        114.7074, 112.5707, 118.5065, 99.7071, 109.7813, 113.0118, 114.5040, 131.0129, 123.8443, 110.1983
    ]
}
...
# 保存为CSV文件
df.to_csv('E:/CTi/china_cities.csv', index=False)
